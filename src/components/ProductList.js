...
function ProductList() {
    ...
    return (
        <div className=" holder flex flex-wrap">
            ...
            className="leftButton h-14 w-14 bg-red-400 mt-40 rounded-full mt-64 ml-6 hover:bg-gray-400" >
            ...
            <button onClick={handleRightButton} disabled={index === filteredProduct.length - 3} className=" rightButton h-14 w-14 bg-red-400 mt-40 rounded-full mt-64 ml-6 hover:bg-gray-400" >
